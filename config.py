#parameters
rho =   3.121 *0.6022  #density of the system
...
temp = 450     #kelvin     #temperature of the system
...
nsteps = 50000  #total number of simulation steps

project_name = "mc4" #name of the project
